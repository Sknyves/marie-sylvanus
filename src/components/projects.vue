...
const projects = [
  {
    id: 1,
    title: "Ivy",
    description: "Assistant virtuel intelligent pour le secrétariat, optimisant la gestion des tâches administratives grâce à une interface Vue.js fluide et un backend Django robuste.",
  ...
  },
  {
    id: 2,
    title: "Kola Son",
    description: "Plateforme de streaming dédiée à la valorisation du patrimoine musical béninois. Une expérience utilisateur immersive développée en Vue.js consommant une API REST Django.",
  ...
  },
  {
    ...
    description: "Vitrine interactive de mes compétences Full-stack, conçue avec Vue.js 3 et Tailwind CSS. Intègre des animations GSAP avancées et une architecture optimisée pour le SEO.",
    image: "/projects/5.png",
    technologies: ["Vue.js", "Tailwind CSS", "GSAP", "SEO"],
    link: "https://portfolio-ah-omega.vercel.app/",
    category: "Web"
  },
  {
    id: 4,
    title: "Waari Festival 2025",
    description: "Site officiel événementiel haute performance. Design responsive et moderne assurant une billetterie fluide et une présentation dynamique des artistes et du programme.",
  ...
  {
    id: 5,
    title: "Intelligence Artificielle Industrielle",
    description: "Application desktop de reconnaissance visuelle intégrant un CNN personnalisé (TensorFlow) pour l'optimisation du contrôle qualité industriel.",
  ...
  },
  {
    id: 6,
    title: "Neon Mind",
    description: "Blog personnel dédié au développement professionnel. Une plateforme de partage de connaissances avec une interface épurée et une navigation intuitive.",
        ...
        >
          ...
          <div class="bg-white rounded-2xl p-3 hover:shadow-xl transition-all duration-300 h-full border border-white hover:border-[#E9E1D1] overflow-hidden">
            ...
            <div class="w-full h-48 mb-6 rounded-xl overflow-hidden relative">
              <img
                :src="project.image"
                :alt="`Projet ${project.title} - ${project.description.substring(0, 50)}...`"
